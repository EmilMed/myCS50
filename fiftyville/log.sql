...
SELECT id, hour, minute, origin_airport_id AS airports.city, destination_airport_id AS airports.city FROM flights WHERE year = 2021 AND month = 7 AND day = 29 ORDER BY hour ASC LIMIT 1;